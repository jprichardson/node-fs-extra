...
const NODE_VERSION_WITH_BIGINT = 1050
const nodeVersion = Number.parseInt(process.versions.node.split('.').join(''), 10)

function getStats (src, dest, cb) {
  if (nodeVersion >= NODE_VERSION_WITH_BIGINT) {
...
function checkPathsSync (src, dest) {
